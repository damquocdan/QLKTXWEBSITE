...
namespace CKSource.CKFinder.Connector.WebApp
{
    ...
    public class Startup
    {
        public void Configuration(IAppBuilder builder)
        {
            ...
            {
                ExcelPackage.LicenseContext = LicenseContext.NonCommercial; // Đặt LicenseContext cho EPPlus
            }
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "exportToExcel",
                    pattern: "AdminQL/Students/ExportToExcel",
                    defaults: new { controller = "Students", action = "ExportToExcel" });
                endpoints.MapControllerRoute(
                    name: "default",
